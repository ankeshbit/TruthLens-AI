...
export function Topbar({ currentPage, analysisStatus, engineOnline }: TopbarProps) {
      ...
      <div className="flex items-center gap-3">
        ...
        {user && (
          <div className="flex items-center gap-1.5">
            ...
            <button
              onClick={() => signOut()}
              className="btn btn-ghost px-2 py-1 h-7 text-[var(--text-muted)] hover:text-red-400"
              title="Sign Out"
              aria-label="Sign Out"
            >
